...
# Ensure offline env defaults are applied early
try:
    # Importing applies conservative offline-related os.environ defaults
    import backend.open_webui.offline_utils  # noqa: F401
except Exception:
    # If import fails (missing deps in this environment), ignore — runtime will handle errors later
    pass
